...
.stApp {
    background: linear-gradient(to right, #f8fbff, #dbefff);
}
...
.stButton > button {
    background: linear-gradient(to right, #4da6ff, #66ccff);
    color: white;
    border-radius: 12px;
    height: 52px;
    width: 100%;
...
.stButton > button:hover {
    background: linear-gradient(to right, #3399ff, #33bbff);
    color: white;
}
...
with col3:
    ...
    monthly_charges = st.number_input('Monthly Charges', min_value=0.0, max_value=1500.0, value=50.0)
...
if st.button('Predict Churn'):
    ...
    st.info("Risk Score closer to 1 means higher chance of customer churn or leave.")